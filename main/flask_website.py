...
def index():
    ...
    if form.validate_on_submit():
        ...
        if (df.empty):
            result_table = "<p style='color:red;'>No results found for your search criteria.</p>"            
            ...
            drop_columns = ['venue','school/department', 'd.i.c.e','session'] # drop session also? Regular Academic Session
...
if __name__ == '__main__':
    ...
    # put host to 0.0.0.0, not 127.0.0.1. Doesnt work for docker containers